...
use culler_core::DebugDefinitionsOutput;
use culler_python::{analyze_debug_definitions, DebugDefinitionsOptions};
...
fn basic_src_layout_snapshot_is_stable() {
    ...
    assert_eq!(
        first,
        include_str!("snapshots/frontend_basic_debug_definitions.json")
    );
}
...
fn flat_layout_snapshot_is_stable() {
    ...
    assert_eq!(
        output,
        include_str!("snapshots/frontend_flatpkg_debug_definitions.json")
    );
}
        ...
        .map(|definition| {
            serde_json::json!({
                "kind": match definition.kind {
                    culler_core::DefinitionKind::Function => "function",
                    culler_core::DefinitionKind::Class => "class",
                },
