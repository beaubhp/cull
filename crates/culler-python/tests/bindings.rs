...
use culler_core::{BindingKind, DebugBindingsOutput, DefinitionKind, ScopeId};
use culler_python::{analyze_debug_bindings, DebugBindingsOptions};
...
fn binding_inventory_snapshot_is_stable() {
    ...
    assert_eq!(
        first,
        include_str!("snapshots/bindings_debug_bindings.json")
    );
}
