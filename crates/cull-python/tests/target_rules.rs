...
fn check_project(root: &Path) -> cull_core::CheckOutput {
...
fn has_rule_name(output: &cull_core::CheckOutput, rule: FindingRule, name: &str) -> bool {
    output
        .findings
        .iter()
        ...
        .all(|finding| {
            matches!(
                ...
                FindingSubject::Binding {
                    binding: cull_core::FindingBinding {
